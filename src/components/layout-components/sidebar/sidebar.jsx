					...
					<nav className="main-menu-container nav nav-pills flex-column sub-open">
						...
						<ul className="main-menu">
							{MenuItems.map((levelone, index) => (
								<Fragment key={index}>
									<li className={`${levelone.menutitle ? "slide__category" : ""} ${levelone.type === "link" ? "slide" : ""} ${levelone.type === "sub" ? "slide has-sub" : ""} ${levelone?.active ? "open" : ""} ${levelone?.selected ? "active" : ""}`}>
										{
											levelone.menutitle ?
										...
										{
											levelone.type === "link" /* && userAuthenState.userpermission?.some((itemsome) => itemsome.NAME == levelone.title) */ ?
												<Link to={levelone.path + "/"} className={`side-menu__item ${levelone.selected ? 'active' : ''}`} >
													<span className={`${local_varaiable?.dataVerticalStyle == 'doublemenu' ? '' : 'd-none'}`}>
														<OverlayTrigger className="" placement="right" overlay={<Tooltip>{levelone.title}</Tooltip>}>
										...
										{
											levelone.type === "empty" ?
												<Link to="#" className='side-menu__item' onClick={handleClick}>{levelone.icon}
													<span className=""> 
														{levelone.title} 
														{
															levelone.badgetxt ? 
